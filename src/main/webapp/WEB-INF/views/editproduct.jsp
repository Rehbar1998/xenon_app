...
<script>
    function showAlert() {
      alert("Product Edit Succesfully!");
    }
  </script>
...
<forms:form action="${pageContext.request.contextPath}/updatepro"  method="post" modelAttribute="pros">
<table>
	<tr>
					...
					<tr>	<td><forms:label path="manufacturer">Product Manufacturer:</forms:label><br>
						...
						<tr><td><input onclick="showAlert()" type="submit" value="Submit Details" class="s"></td></tr>
